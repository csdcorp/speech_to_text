...
void main() {
  ...
  group('json', () {
    ...
    test('roundtrips correctly', () {
      ...
      SpeechRecognitionResult roundtripResult = SpeechRecognitionResult.fromJson(roundTripJson);
  ...
  group('overrides', () {
    test('toString works with no alternates', () {
      SpeechRecognitionResult result = SpeechRecognitionResult([], true );
      expect( result.toString(), "SpeechRecognitionResult words: [], final: true" );
    });
    test('toString works with alternates', () {
      SpeechRecognitionResult result = SpeechRecognitionResult([ firstWords], true );
      expect( result.toString(), "SpeechRecognitionResult words: [SpeechRecognitionWords words: hello,  confidence: 0.85], final: true" );
    });
    ...
    test('hash differs for different objects', () {
      SpeechRecognitionResult result1 = SpeechRecognitionResult([ firstWords], true );
      SpeechRecognitionResult result2 = SpeechRecognitionResult([ secondWords], true );
    ...
    test('equals same for different object same values', () {
      SpeechRecognitionResult result1 = SpeechRecognitionResult([ firstWords], true );
      SpeechRecognitionResult result1a = SpeechRecognitionResult([ firstWords], true );
