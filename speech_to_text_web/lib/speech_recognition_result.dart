...
class WebSpeechRecognitionResult {
  List<WebSpeechRecognitionWords> _alternates;
  ...
  /// confidence values.
  List<WebSpeechRecognitionWords> get alternates =>
  ...
  bool isConfident(
          {double threshold = WebSpeechRecognitionWords.confidenceThreshold}) =>
  ...
  WebSpeechRecognitionResult(this._alternates, this.finalResult);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is WebSpeechRecognitionResult &&
  ...
  factory WebSpeechRecognitionResult.fromJson(Map<String, dynamic> json) =>
      _$SpeechRecognitionResultFromJson(json);
  Map<String, dynamic> toJson() => _$SpeechRecognitionResultToJson(this);

  WebSpeechRecognitionResult toFinal() {
    return WebSpeechRecognitionResult(_alternates, true);
  }
}

/// A set of words recognized in a [WebSpeechRecognitionResult].
///
/// Each result will have one or more [WebSpeechRecognitionWords]
/// with a varying degree of confidence about each set of words.
@JsonSerializable()
class WebSpeechRecognitionWords {
  ...
  const WebSpeechRecognitionWords(this.recognizedWords, this.confidence);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        other is WebSpeechRecognitionWords &&
            recognizedWords == other.recognizedWords &&
  ...
  factory WebSpeechRecognitionWords.fromJson(Map<String, dynamic> json) =>
