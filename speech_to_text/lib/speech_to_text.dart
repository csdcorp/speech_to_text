...
/// Notified when a debug log message is generated by the plugin.
///
/// This is only active when debug logging is enabled during initialization.
/// See the [onDebugLog] argument on the [SpeechToText.initialize] method for use.
typedef SpeechDebugLogListener = void Function(String message);
...
class SpeechToText {
  ...
  SpeechDebugLogListener? debugLogListener;
  ...
  ///
  /// [onDebugLog] is an optional listener for debug log messages from the
  /// Android plugin. This is only active when [debugLogging] is enabled.
  /// Use this to monitor internal plugin operations for troubleshooting.
  ...
  Future<bool> initialize(
      ...
      SpeechDebugLogListener? onDebugLog,
      debugLogging = false,
    ...
    SpeechToTextPlatform.instance.onDebugLog = _onDebugLog;
  ...
  void _onDebugLog(String message) {
    if (null != debugLogListener) {
      debugLogListener!(message);
    }
  }
}
